...
module.exports = function(app) {
    ...
    app.get('/users/forgot', function(req, res) {
        ...
        res.render(path.join(__dirname, "../../views")+'/acct-manage/forgot', { title : app.title, user : req.user, message: req.flash('info') }); 
    });
	...
	app.get('/users/reset/:token', function(req, res) {
	  User.findOne({ 'local.resetPasswordToken': req.params.token, 'local.resetPasswordExpires': { $gt: Date.now() } }, function(err, user) {
		...
		res.render(path.join(__dirname, "../../views")+'/acct-manage/reset', {
